<div class="modal fade" id="askPasswordOnProductNameConfirmDeletionModal" tabindex="-1" aria-labelledby="askPasswordOnProductNameConfirmDeletionModalLabel" aria-hidden="true">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
          <div class="mb-3">
            ...
            <input type="password" class="form-control" id="productNamePasswordInput" name="password" required>
          </div>
      </div>

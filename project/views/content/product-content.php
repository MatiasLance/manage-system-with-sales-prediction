...
<div class="container product-content">
    ...
    <div class="tab-content" id="myTabContent">
        <div class="tab-pane fade show active" id="product-tab-pane" role="tabpanel" aria-labelledby="product-tab" tabindex="0">
            <!-- Create product button and also trigger for add product modal -->
            <button type="button" class="btn btn-milk-white btn-sm mb-5" data-bs-toggle="modal" data-bs-target="#addProductModal" data-bs-auto-close="false">Create Product</button>
            <ul class="nav nav-underline mb-5" id="myTabOne" role="tablist">
                <!-- Dairy Products Tab -->
                <li class="nav-item" role="presentation">
            ...
            <div class="tab-content" id="myTabOneContent">
                ...
                <div class="tab-pane fade" id="grain-and-cereals-product-tab-pane" role="tabpanel" aria-labelledby="grain-and-cereals-product-tab" tabindex="0">
                    ...
                    <!-- Search Input -->
                    <input type="text" id="searchGrainsAndCerealsProducts" class="form-control mb-3" placeholder="Search by name...">
        ...
        <!-- Search for Product Name -->
        <input type="text" id="searchAchivedProductName" class="form-control mb-3" placeholder="Search by name...">

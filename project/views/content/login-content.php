          ...
          <div class="row">
            <div class="col-12">
              <div class="text-center mb-5">
                  <img id="adminLoginFormLogo" src="<?php echo isset($_SESSION['sidebar_menu_logo']) ? $_SESSION['sidebar_menu_logo']: 'https://i.imgur.com/3LvoZ6D.png'?>" alt="Goat Farm Logo" width="175" height="157">
              </div>
            </div>
          </div>
          <form id="login">
